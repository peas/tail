...
public class ReportXlsGeneratorTest {

	private final String CHAR_DIST = "./";
	
	private ReportXlsGenerator XLSReportSeries;
	...
	public void setUp() throws IOException {
		XLSReportSeries = new ReportXlsGenerator(new HSSFWorkbook());
		...
		sheet = XLSReportSeries.generate(report, period, charts);
	}
